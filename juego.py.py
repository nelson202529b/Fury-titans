...
pygame.display.set_caption("Fury titans")
...
#load spritesheets
warrior_sheet = pygame.image.load("C:/Users/David/main.py/juego_pi/imagenes/Martial Hero 2/Sprites/Martial Hero 2.png").convert_alpha()
...
WARRIOR_ANIMATION_STEPS = [8, 8, 7, 2, 4, 6, 2, 8]
WIZARD_ANIMATION_STEPS = [4, 4, 7, 2, 4, 2, 8, 3]
